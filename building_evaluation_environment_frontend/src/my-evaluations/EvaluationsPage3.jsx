          ...
          <ul>
            {evaluations.map((evaluation) => (
              <li key={evaluation.id}>
                ...
                <div>
                  Energy Performance Score: {evaluation.energyPerformanceScore}
                </div>
                <div>
                  Indoor Environmental Quality Score:{" "}
                  {evaluation.indoorEnvironmentalQualityScore}
                </div>
                <div>
                  Environment and Circularity Score:{" "}
                  {evaluation.environmentCircularityScore}
                </div>
                <div>Accessibility Score: {evaluation.accessibilityScore}</div>
                <div>Total Score: {evaluation.totalScore}</div>
                <div>Year of Evaluation: {evaluation.year}</div>
                {/* <div>Email of Owner: {evaluation.ownerEmail}</div> */}
              </li>
            ))}
          </ul>
        </div>
